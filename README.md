...
Group activities is being fetched from Nordic Wellness every 15 min. It can also be manually updated with the blue `Refresh` button on the bottom of `http://server:8000`
