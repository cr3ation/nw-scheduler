"""
Django settings for nordicwellness project.
...
ALLOWED_HOSTS.extend(
    filter(
        None,
        os.environ.get('ALLOWED_HOSTS', '').split(',') # '192.168.1.239', 'localhost', '127.0.0.1'
    )
)
...
# Add this line to specify the directory for static files collected by 'python manage.py collectstatic'
